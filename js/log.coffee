...
pass = (label, args...) ->
    ...
    log '[c="color: #1adb00"] ' + label + ' [c]', args

warn = (label, args...) ->
    return unless window.console and window.console.log
    log '[c="color: red"] ' + label + ' [c]', args

bang = (label, args...) ->
    return unless window.console and window.console.log
    log '[c="color: #fff; font-size: 20px; padding: 10px 15px; background: #444; border-radius: 4px; line-height: 50px; text-shadow: 0 1px #000"]' + label + '[c]'
